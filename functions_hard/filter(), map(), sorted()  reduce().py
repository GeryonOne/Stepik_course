...
data = sorted(data)
filter_data = list(filter(lambda d: d[1] > 10000000 and d[2] == 'primary', data))
map_data = list(map(lambda x: x[0], filter_data))
reduce_result = reduce(lambda w1, w2: w1 + ', ' + w2, map_data)
